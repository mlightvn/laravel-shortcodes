...
use NamTenTen\ShortCodes\Test\Dummies\TestCachedWidget;
...
class WidgetFactoryTest extends TestCase
{
    ...
    {
        $this->expectException('\NamTenTen\ShortCodes\Misc\InvalidWidgetClassException');
    ...
    {
        $output = $this->factory->run('\NamTenTen\ShortCodes\Test\Dummies\TestDefaultSlider');
    ...
    {
        $this->expectException('NamTenTen\ShortCodes\Misc\NamespaceNotFoundException');
