...
namespace NamTenTen\ShortCodes\Console;
...
class WidgetMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'make:shortcodes';
     ...
     * @var string
     */
    protected $description = 'Create a new shortcode (namtenten/laravel-shortcodes)';
    ...
    {
        $view = 'shortcodes.'.str_replace('/', '.', $this->makeViewName());
    ...
    {
        return base_path('resources/views').'/shortcodes/'.$this->makeViewName().'.blade.php';
    }
