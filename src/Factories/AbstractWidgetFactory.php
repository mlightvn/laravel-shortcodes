...
namespace NamTenTen\ShortCodes\Factories;

use NamTenTen\ShortCodes\AbstractWidget;
use NamTenTen\ShortCodes\Contracts\ApplicationWrapperContract;
use NamTenTen\ShortCodes\Misc\EncryptException;
use NamTenTen\ShortCodes\Misc\InvalidWidgetClassException;
use NamTenTen\ShortCodes\Misc\ViewExpressionTrait;
...
abstract class AbstractWidgetFactory
{
    ...
    protected function instantiateWidget(array $params = [])
    {
        ...
        if (!is_subclass_of($widgetClass, 'NamTenTen\ShortCodes\AbstractWidget')) {
            throw new InvalidWidgetClassException('Class "'.$widgetClass.'" must extend "NamTenTen\ShortCodes\AbstractWidget" class');
        }
